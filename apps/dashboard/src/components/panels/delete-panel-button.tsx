    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            The Discord message and the panel row are removed permanently. Ticket types attached to
            this panel are removed too.
          </DialogDescription>
        </DialogHeader>
        ...
        <ul className="space-y-2.5 text-sm">
          <li className="flex items-start gap-2">
            ...
            />
            <span>
              <span className="font-medium">Existing open tickets stay open.</span>{' '}
              <span className="text-[color:var(--color-fg-muted)]">
                Their channels remain — close them from Discord or the tickets page.
              </span>
            </span>
          </li>
          <li className="flex items-start gap-2">
            ...
            />
            <span>
              <span className="font-medium">No new tickets can be opened.</span>{' '}
              <span className="text-[color:var(--color-fg-muted)]">
                Members lose the entry point when the message disappears.
              </span>
            </span>
          </li>
        </ul>
